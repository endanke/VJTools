// Using http://www.openprocessing.org/sketch/30110
public class BloomPProcess
{
  
  private PImage    bloomTarget;  
  private int       BloomThreshold   = 220; //the minimum brightness that will be "bloomed"
  private int       BloomRadius      = 10;   //the radius of the bloom
